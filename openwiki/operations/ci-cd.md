...
| **Node.js** | v22 |
| **OpenWiki version** | Unpinned (installed via `npm install --global openwiki`) |
| **Model** | `z-ai/glm-5.2` via OpenRouter API |
| **Tracked paths** | `openwiki/`, `AGENTS.md`, `CLAUDE.md`, `.github/workflows/openwiki-update.yml` |
| **Observability** | LangSmith tracing enabled (`LANGSMITH_API_KEY`, `LANGCHAIN_PROJECT: openwiki`) |
