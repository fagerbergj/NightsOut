...
import com.wit.jasonfagerberg.nightsout.v1.addDrink.drinkSuggestion.DrinkSuggestionArrayAdapter
import com.wit.jasonfagerberg.nightsout.v1.addDrink.drinkSuggestion.DrinkSuggestionAutoCompleteView
import com.wit.jasonfagerberg.nightsout.v1.utils.Converter
import com.wit.jasonfagerberg.nightsout.v1.databaseHelper.AddDrinkDatabaseHelper
...
import com.wit.jasonfagerberg.nightsout.v1.main.MainActivity
import com.wit.jasonfagerberg.nightsout.v1.main.NightsOutActivity
import com.wit.jasonfagerberg.nightsout.v1.manageDB.ManageDBActivity
...
class AddDrinkActivity : NightsOutActivity() {
    ...
    private fun setupSpinner() {
        mSpinnerAmount = findViewById(R.id.spinner_edit_drink_amount)
    ...
    private fun setupComplexModeCheckbox() {
        ...
        mEditAmount = findViewById(R.id.edit_edit_drink_amount)
    }
    ...
    fun fillViews(name: String, abv: Double, amount: Double, measurement: String) {
        ...
        val mEditAmount = findViewById<EditText>(R.id.edit_edit_drink_amount)
        val dropdown = findViewById<Spinner>(R.id.spinner_edit_drink_amount)
    ...
    fun isInputErrors(): Boolean {
        ...
        val measurement = findViewById<Spinner>(R.id.spinner_edit_drink_amount).selectedItem.toString()
