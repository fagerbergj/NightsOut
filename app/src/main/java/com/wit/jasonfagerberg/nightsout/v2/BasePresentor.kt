package com.wit.jasonfagerberg.nightsout.v2
...
abstract class BasePresenter<Intent, Action, Result, ViewModel>(
    ...
    private val viewModelStream: BehaviorRelay<ViewModel> = BehaviorRelay.createDefault(initialViewModel)
    ...
    fun viewModelStream(): Observable<ViewModel> = viewModelStream.observeOn(AndroidSchedulers.mainThread())
